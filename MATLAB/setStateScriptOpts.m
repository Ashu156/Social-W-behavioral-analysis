...
% This function specifies text import options to read stateScript log files
%...It is used as part of the script called
%GenerateDataStructure_DIOPokingData.mlx
