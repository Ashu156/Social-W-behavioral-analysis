...
int deliverPeriod = 500     % Reward duration (ms)
...
callback portin[10] up  % Left well
    ...
    else if lastWell == 2 || lastWell == 3 do
        disp('Left well rewarded')
        rewardWell = rewardPump1
        trigger(1)
        count = count + 1
...
callback portin[14] up  % Center well
    ...
    if lastWell == 0 do
        ...
        trigger(4)  % Raise barrier
        trigger(5)  % Lower after delay
    else if lastWell == 1 && (lastSideWell == 0 || lastSideWell == 3) do
        disp('Center well rewarded')
        rewardWell = rewardPump2
        trigger(1)
        count = count + 1
...
callback portin[9] up  % Right well
    ...
    if lastWell == 0 do
        ...
        trigger(4)  % Raise barrier
        trigger(5)  % Lower after delay
    else if lastWell == 1 && (lastSideWell == 0 || lastSideWell == 2) do
        disp('Right well rewarded')
        rewardWell = rewardPump3
        trigger(1)
        count = count + 1
